...
def do_thing(img_name):
    ...
    # image_to_show.append({ 'title' : img})
    # image_to_show.append({ 'title' : img_gray})
    image_to_show.append({
        'img': img,
        'title': 'original'
    })
    image_to_show.append({
    ...
    # image_to_show.append({ 'title' : img_gray_hat})
    image_to_show.append({
        'img': img_gray_hat,
        'title': 'img_gray_hat'
    })
    ...
    image_to_show.append({ 'img' : img_blurred, 'title' : 'img_blurred'})
    ...
    image_to_show.append({ 'img' : img_threshed, 'title' : 'img_threshed'})
    ...
    image_to_show.append({ 'img' : img_threshed2, 'title' : 'img_threshed2'})
    ...
    image_to_show.append({ 'img' : img_threshed3, 'title' : 'img_threshed3'})
    ...
    image_to_show.append({ 'img' : temp_result, 'title' : 'temp_result'})
    ...
    def find_chars(contour_list):
        ...
        for d1 in contour_list:
            ...
            print(f'unmatched_contours_idx {unmatched_contours_idx.shape}')
    ...
    for i, matched_chars in enumerate(matched_result):
        ...
        image_to_show.append({ 'img' : img_cropped, 'title' : 'img_cropped'})
    ...
    for i, img in enumerate(image_to_show):
        add_subplot_image(fig, img['img'], img['title'], i+1)
    plt.show()
